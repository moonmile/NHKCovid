...
{ code: 0, name: "Zimbabwe",	population: 14645500 }, 
  ...
  methods: {
    ...
    async getData() {
      ...
      data = this.makeCasesRt( res, "2020-10-01", "2021-12-31", this.value )
      this.datart.labels = data.labels ;
      this.datart.datasets = data.datasets ;

      data = this.makeCasesFuture( res, "2020-12-01", "2021-12-31", this.value )
      this.datafu.labels = data.labels ;
      this.datafu.datasets = data.datasets ;
